...
//Application Title
define('APP_TITLE', 'Image Manager');
...
$root_path = $_SERVER['DOCUMENT_ROOT']."/saral/Assets/event/";
        ...
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p>
                    ...
                    <b><a href="<?php echo "../../saral/Assets/event/".fm_enc(fm_convert_win($file)) ?>" target="_blank"><i class="fa fa-external-link-square"></i> <?php echo lng('Open') ?></a></b>
                    &nbsp;
                    <?php
                    // ZIP actions
            ...
            if($is_onlineViewer) {
                ...
                if (in_array($ext, array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))) {
                    echo '<p><img src="' . "../../saral/Assets/event/".fm_enc(fm_convert_win($file)) . '" alt="" class="preview-img"></p>';
                }
            } elseif ($is_audio) {
                // Audio content
                    ...
                    <td>
                        ...
                        <?php
                           if (in_array(strtolower(pathinfo($f, PATHINFO_EXTENSION)), array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))): ?>
                                <?php $imagePreview = fm_enc("../../saral/Assets/event/" . $f); ?>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a href='../'><button type='button' class='btn btn-primary'>Admin Home</button></a>";
